...
```
cd existing_repo
git remote add origin https://gitlab.com/georgiiwinistr1977-group/app.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/georgiiwinistr1977-group/app/-/settings/integrations)
